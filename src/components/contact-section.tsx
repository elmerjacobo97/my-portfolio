...
export function ContactSection() {
  ...
  return (
    <section className="py-24 md:py-32 bg-gradient-to-br from-muted/30 via-background to-muted/20 relative overflow-hidden">
      {/* Background */}
        ...
        <div className="space-y-8">
          ...
          >
            ...
            <Button
              variant="outline"
              size="lg"
              className="group text-lg px-8 py-6 transition-all"
