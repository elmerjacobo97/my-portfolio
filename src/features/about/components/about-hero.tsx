      ...
      <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid sm:grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="space-y-6 md:space-y-8 sm:order-2 lg:order-1">
            ...
            >
              <Button
                className="shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 transition-all hover-lift"
          ...
          >
            <div className="relative mx-auto lg:mx-0 w-64 h-64 md:w-72 md:h-72 lg:w-80 lg:h-80">
              ...
              <div
                className="absolute -bottom-4 -left-4 bg-primary text-primary-foreground p-3 rounded-xl shadow-lg animate-float"
